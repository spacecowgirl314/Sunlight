...
- (id)initWithFrame:(NSRect)frame
{
	...
	if (self) {
		...
		//[self setEndingColor:[NSColor blackColor]];
		 [self setStartingColor:[NSColor colorWithDeviceRed:0.965 green:0.965 blue:0.965 alpha:1.0] endingColor:[NSColor colorWithDeviceRed:0.894 green:0.894 blue:0.894 alpha:1.0]];
		[self setAngle:270];
	}
	return self;
}
